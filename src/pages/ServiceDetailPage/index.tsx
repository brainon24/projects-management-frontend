...
export const ServiceDetailPage = () => {
    ...
    return (
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: 'calc(100dvh - 160px)' }}>
            ...
            <p>La subcategoría que buscas no existe.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div>
        ...
        {!serviceDetail && (
            ...
            textAlign: 'center'
                ...
                <p style={{ color: '#6c757d', fontSize: '1.1rem' }}>
                    Información detallada próximamente para {serviceItem.title}
                </p>
            </div>
        )}
      </div>
      ...
      <WhatsAppButton 
        message={`Hola, me interesa conocer más sobre el servicio: ${serviceItem.title}`}
      />
    </div>
  );
}
